...
class YesAnswerNotificationReplyButtonStrategy(
    ...
    override fun reply(callbackQuery: CallbackQuery) {
        ...
        val messageText =
            messageProvider
                .getMessage(
                    ...
                    NotificationQuestionEditedContext(AnswerNotificationType.YES.displayName),
                ).text
        ...
        SendMessage(
            chatId.toString(),
            messageProvider.getMessage(MessageSpec.NotificationWaterAmountMenu, NoContext).text,
        ).apply {
